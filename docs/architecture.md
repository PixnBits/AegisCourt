# AegisCourt – Architectural Decisions & High-Level Design v0.1
**Status:** Draft – Architect-reviewed (March 14, 2026)  
**Version:** 0.1  
...
| Governance Court Engine| Orchestrate reviewers, collect decisions        | Bounded autonomy, multi-viewpoint reasoning  | Prompt templates + multi-LLM      |
